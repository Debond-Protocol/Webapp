    ...
    <>
            ...
            <div style={{width: '100%', textAlign: "center"}}>
              ...
              <Row gutter={24} align={"middle"}>
                <Col span={24} style={{textAlign: "center"}}>
                  <Divider plain style={{fontSize: 13, color: "rgba(255, 255, 255, 0.45)"}}>Change Value</Divider>
                  <Slider
                    min={0}
      ...
      <div style={{display: "flex", justifyContent: "center", margin: 70}}>
        {approved ? <button className="dbutton" onClick={deposit}>Deposit</button> :
          <button className={"dbutton"} disabled={loading} onClick={approve}>Approve</button>}
      </div>
    </>
  );
}