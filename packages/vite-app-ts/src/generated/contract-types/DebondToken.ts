...
export interface DebondTokenInterface extends utils.Interface {
  contractName: 'DebondToken';
  functions: {
...
export interface DebondToken extends BaseContract {
  contractName: 'DebondToken';
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DebondTokenInterface;
