...
export interface DebondBondTestInterface extends utils.Interface {
  contractName: 'DebondBondTest';
  functions: {
...
export interface DebondBondTest extends BaseContract {
  contractName: 'DebondBondTest';
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DebondBondTestInterface;
